...
pub use super::constraint_model::IdentityConstraintType as ConstraintType;

/// Identity constraint definition from XSD.
pub type IdentityConstraint = super::constraint_model::IdentityConstraintModel<String>;
